// nested loop demo - input a series of numbers.
// continue to calculate the sum of these numbers
// until a user enters a 0. 
...
int main(int nNumberofArgs, char* pszArgs[])
{
    ...
    cout << "This program sums multiple series\n"
        ...
        << "negative numbers in row.\n";
    //continue to accumulate sequences
    int accumulator;
    do
    {
        // stert entering the next sequence of numbers
        accumulator = 0;
        ...
        for (;;)
        {
            ...
            // otherwise add the number to the accumlstor
        ...
        // if the accumulated sequence was no zero
    } while (accumulator != 0);
    // we're about to quit
    cout << "Thank you!" << endl;
